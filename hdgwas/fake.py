...
class Encoder(object):
	...
	def save_npy(self,data, save_path=None, info=None):
		#only for phenotype
	...
	def save_hdf5(self,data, save_path=None):
		...
		atom = tables.Float32Atom() # TODO (mid) check data format, Int8Atom works only for best guess, minimac needs Float16
